...
void SETTINGS_InitEEPROM(void)
{
	...
	gEeprom.KEY_1_LONG_PRESS_ACTION      = (Data[2] < ACTION_OPT_LEN) ? Data[2] : ACTION_OPT_ARDF_ON_OFF;
...
gARDFMistuneFreqRaw = 0;
	...
	if ( Data[4] != 0xFF && Data[4] >= 1 && Data[4] <= ARDF_SNAPSHOT_SPEED_MAX )
	{
		gARDFSnapshotSpeed = Data[4];
	}
	else
	{
		gARDFSnapshotSpeed = ARDF_SNAPSHOT_SPEED_DEFAULT;
	}
...
void SETTINGS_SaveARDF(void)
{
	...
	ARDFCfg2.SnapshotSpeed = gARDFSnapshotSpeed;
