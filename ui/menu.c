...
//   text,     voice ID,                    menu ID
	...
	{"Morse",  VOICE_ID_INVALID,            MENU_MORSE_SPEED         },
#endif
...
const t_sidefunction gSubMenu_SIDEFUNCTIONS[] =
{
	...
	{"SnpSpd\n+",		ACTION_OPT_ARDF_SNAPSHOT_SPEED_UP},
	{"SnpSpd\n-",		ACTION_OPT_ARDF_SNAPSHOT_SPEED_DOWN},
#endif
};
...
//			UI_PrintStringSmallNormal(String, 0, 0, 0);
	...
	switch (UI_MENU_GetCurrentMenuId())
	{
		...
		case MENU_MORSE_SPEED:
			sprintf(String, "%d wpm", gMorseSpeedWpm);
			break;
